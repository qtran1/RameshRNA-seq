...
liver.HFVvsNV.sig.genes <-liver_interxn[which(liver_interxn$padj.HFVeh_vs_NormVeh < 0.05),20] 
liver.HFGTXvsNV.sig.genes <- liver_interxn[which(liver_interxn$padj.HFGTX_vs_NormVeh <0.05),20]
liver.HFGTXvsHFV.sig.genes <- liver_interxn[which(liver_interxn$padj.HFGTX_vs_HFVeh <0.05),20]
...
#HFVeh vs NormVeh
#get rid of NA folchanges and then order by log2 foldchange
wat.HFVvsNV.sig.genes <-wat_interxn[which(wat_interxn$padj.HFVeh_vs_NormVeh < 0.05),20] 
wat.HFGTXvsNV.sig.genes <- wat_interxn[which(wat_interxn$padj.HFGTX_vs_NormVeh <0.05),20]
wat.HFGTXvsHFV.sig.genes <- wat_interxn[which(wat_interxn$padj.HFGTX_vs_HFVeh <0.05),20]
