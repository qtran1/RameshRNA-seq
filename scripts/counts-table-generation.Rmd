...
counts.table['pct_no_feature',] <- counts.table['no_feature',]/counts.table['total_reads',]*100
counts.table['ambiguous',] <- counts.table['ambiguous ',]/counts.table['total_reads',]*100
counts.table['pct_not_unique',] <- counts.table['alignment_not_unique',]/counts.table['total_reads',]*100
counts.table['mapped_reads',] <- counts.table['total_reads',]-counts.table['pct_no_feature',]-counts.table['pct_not_unique',]
