...
nk_cells <- c('Ifng','Lat','Ncr1', 'Vav3','Shc2', 'Klrc1', 'Sh2d1a', 'Cd247', 'Fcer1g','Cd48')
  
gene.data.name <- c('cortisol_signaling', 'adipocytes', 'brown_fat', 'white_fat', 'beige_fat', 'lipolysis', 'lipid_metabolism', 'unsat_FA', 'adipocyte_regulator', 'wnt', 'ppar_genes', 'adipocyte1', 'adipocyte2', 'adipocyte3', 'hormones', 'genes_exp_less100', 'genes_exp_more100', 'genes_exp_less40', 'genes_exp_1000','nk_cells')
