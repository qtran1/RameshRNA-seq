...
twocoordinate <- function(LHS, RHS, list_name, index){
  require(ggplot2)
...
lhs <- c('Adipoq') 
rhs <- c('Fabp4', 'Pck1', 'Agt')
ppar <- c('Adipoq', 'Fabp4', 'Pck1', 'Agt')
scale_index <- c(rep("scale 1",9), rep("scale 2", 3))
twocoordinate(lhs, rhs, ppar, scale_index)

lhs <- c('Acox2', 'Slc27a2')
rhs <- c('Idh1', 'Phyh', 'Scp2', 'Amacr')
peroxisomal_lipid <- c('Acox2', 'Slc27a2', 'Idh1', 'Phyh', 'Scp2', 'Amacr')
scale_index <- c(rep("scale 1",3), rep("scale 2", 12), rep("scale 1", 3))
twocoordinate(lhs, rhs, peroxisomal_lipid, scale_index)

lhs <- c('Cyp7a1', 'Apoa5', 'Fabp1', 'Ppargc1b', 'Abcb4', 'Ppargc1a', 'Ppara', 'Tead4', 'Ncoa1')
rhs <- c('Apoa1', 'Apoa2', 'Agt', 'Pparg', 'Slc27a1', 'Ctgf', 'Gos2', 'Alas1', 'Tead1', 'Trib3', 'Hmgcs2', 'Acadm', 'Yap1', 'Cpt2', 'Rxra', 'Nr1d1')
...
twocoordinate(lhs, rhs, ppara_activate_ge, scale_index)

lhs <- c('Cyp7a1', 'Baat', 'Slc27a5', 'Slc10a1', 'Acox2', 'Abcb11', 'Cyp8b1', 'Slc27a2', 'Akr1d1', 'Cyp7b1')
rhs <- c('Alb', 'Cyp27a1', 'Hsd3b7')
...
twocoordinate(lhs, rhs, bile_salt, scale_index)

lhs <- c('Apof', 'Apoc3', 'Apoa1', 'Apoa2', 'Lcat', 'Slco2a1', 'Ldlr', 'Ppara')
rhs <- c('Apoe', 'Tspo')
...
twocoordinate(lhs, rhs, lipid_transport, scale_index)
```
