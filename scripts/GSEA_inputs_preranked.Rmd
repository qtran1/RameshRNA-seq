...
#HFGTX vs HFVeh
#get rid of NA foldchanges or pvalues and then order by log2 foldchange
...
write.table(wat.HFGTXvsHFVeh.noDup, file="../data/processed/GSEA_WAT_HFGTXvsHFVeh_preranked.rnk", sep="\t", row.names=FALSE, quote=FALSE)
